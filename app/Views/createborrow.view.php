...
<div class="form-style-2">
    ...
    <form action="upsert" method="post">
        ...
        <label for="date"><span>Datum <span class="required">*</span></span><input type="date" class="input-field" name="date" value="<?php echo date_create($borrow->borrowdate)->format('yy-m-d') ?? ''; ?>" required /></label>
        ...
        <label for="status"><span>Status<span class="required">*</span></span><select name="status" class="select-field" required>
                <option value="<?php echo $borrow->membership ?? ''; ?>" selected disabled hidden>
                </option>
